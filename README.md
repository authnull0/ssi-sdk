[![godoc ssi-sdk](https://img.shields.io/badge/godoc-ssi--sdk-blue)](https://pkg.go.dev/github.com/authnull0/ssi-sdk)
[![go version 1.19.2](https://img.shields.io/badge/go_version-1.19.2-brightgreen)](https://golang.org/)
[![Go Report Card A+](https://goreportcard.com/badge/github.com/authnull0/ssi-sdk)](https://goreportcard.com/report/github.com/authnull0/ssi-sdk)
[![license Apache 2](https://img.shields.io/badge/license-Apache%202-black)](https://github.com/authnull0/ssi-sdk/blob/main/LICENSE)
[![issues](https://img.shields.io/github/issues/TBD54566975/ssi-sdk)](https://github.com/authnull0/ssi-sdk/issues)
![ssi-sdk-ci status](https://github.com/authnull0/ssi-sdk/workflows/ssi-sdk-ci/badge.svg?branch=main&event=push)
...
[CONTRIBUTING](https://github.com/authnull0/ssi-sdk/blob/main/CONTRIBUTING.md). Our current thinking about the
development of the library is captured in
[GitHub Issues](https://github.com/authnull0/ssi-sdk/issues).
...
view [CONTRIBUTING](https://github.com/authnull0/ssi-sdk/blob/main/CONTRIBUTING.md) for more information.
...
|----------------------------------------------------------------------------------------|-------------------------------------------------------------------------------|
| [VISION](https://github.com/authnull0/ssi-sdk/blob/main/doc/VISION.md)               | Outlines the project vision                                                   |
| [VERSIONING](https://github.com/authnull0/ssi-sdk/blob/main/doc/VERSIONING.md)       | Project versioning strategy                                                   |
| [CODE_OF_CONDUCT](https://github.com/authnull0/ssi-sdk/blob/main/CODE_OF_CONDUCT.md) | Expected behavior for project contributors, promoting a welcoming environment |
| [CONTRIBUTING](https://github.com/authnull0/ssi-sdk/blob/main/CONTRIBUTING.md)       | Developer guide to build, test, run, access CI, chat, discuss, file issues    |
| [GOVERNANCE](https://github.com/authnull0/ssi-sdk/blob/main/GOVERNANCE.md)           | Project governance                                                            |
| [LICENSE](https://github.com/authnull0/ssi-sdk/blob/main/LICENSE)                    | Apache License, Version 2.0                                                   |
